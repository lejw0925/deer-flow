...
class AppConfig(BaseModel):
    ...
    skill_scan: SkillScanConfig = Field(default_factory=SkillScanConfig, description="Skill safety scanning configuration for archive installs and other skill writes")
